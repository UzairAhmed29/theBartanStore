            ...
            <div class="body">
                ...
                <form class="form-auth-small m-t-20" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" name="email" class="form-control round @error('email') is-invalid @enderror" id="email signin-email" value="" placeholder="E-Mail" required autocomplete="email" autofocus>
                         @error('email')
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" class="form-control round @error('password') is-invalid @enderror" id="signin-password password" value="" placeholder="Password" name="password" required autocomplete="current-password">
                        @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
